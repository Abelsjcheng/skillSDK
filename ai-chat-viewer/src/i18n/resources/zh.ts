export const zh = {
  ...
  'weAgent.sessionActions': '会话操作',
  'weAgent.renameSession': '重命名',
  ...
  'createAssistant.namePlaceholder': '例如：智能助手(2-50个字符)',
  'createAssistant.description': '简介',
  'createAssistant.descriptionPlaceholder': '介绍助手的功能和应用场景(2-250个字符)',
